    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('mitre_attack_groups', models.ManyToManyField(blank=True, help_text='Grupos de elementos MITRE ATT&CK (táticas, técnicas, subtécnicas) relacionados', related_name='alerts', to='core.mitreattackgroup', verbose_name='MITRE ATT&CK Groups')),
                ('mitre_subtechniques', models.ManyToManyField(blank=True, related_name='alerts', to='core.mitresubtechnique', verbose_name='MITRE Sub-techniques')),
                ('mitre_tactics', models.ManyToManyField(blank=True, related_name='alerts', to='core.mitretactic', verbose_name='MITRE Tactics')),
                ('mitre_techniques', models.ManyToManyField(blank=True, related_name='alerts', to='core.mitretechnique', verbose_name='MITRE Techniques')),
